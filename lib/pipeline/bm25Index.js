...
export async function persistBM25Index(bm25Index, sessionId) {
    try {
        ...
        const payload = JSON.stringify({
            // JSON.stringify invokes miniSearch.toJSON() itself — the old
            // JSON.parse(JSON.stringify(...)) wrapper serialized the whole
            // index three times over, synchronously blocking the event loop.
            index: bm25Index.miniSearch,
