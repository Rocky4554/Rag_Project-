...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Classify the candidate's intent. Be VERY lenient — any genuine attempt to answer = "normal".

Intent options:
- "normal"     → ANY genuine attempt to answer, even wrong, incomplete, rambling, or partially confused
- "skip"       → explicitly wants to skip THIS question (e.g. "skip", "I don't know", "next question", "pass", "move on")
- "stop"       → wants to END the interview entirely (e.g. "stop", "end", "end the interview", "quit", "finish", "I'm done", "that's enough", "I want to stop", "let's stop here")
- "nervous"    → expressing anxiety or mental freeze (e.g. "I'm blanking", "I'm nervous", "I'm freezing", "I can't think right now")
- "unwell"     → health issue (e.g. "I'm sick", "I need a break", "I don't feel well", "I need to stop for health reasons")
- "confused"   → does NOT understand the QUESTION itself (e.g. "I don't understand", "what do you mean", "can you repeat", "can you rephrase", "I have no idea what you're asking", "I'm confused by the question")
- "meta"       → asking about the interview process itself (e.g. "how many questions remaining", "what's my score", "how am I doing", "what topic is this", "how many left")
- "irrelevant" → asking or saying something completely unrelated to the interview OR the topic (e.g. chatting, jokes, unrelated questions) — NOT confusion about the question

Voice-to-text corrections:
- "saw the interview" / "and the interview" = "stop" → stop
- "dont no" / "no idea" = "I don't know" → skip
- "can you repeat" / "say that again" → confused
- single word "end" or "finish" alone → stop
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{
  "intent": "<normal|skip|stop|nervous|unwell|confused|meta|irrelevant>",
  ...
  "keyConceptMissed": "<specific missed concept or empty string>"
    ...
    interviewLog.info(
        { intent: validatedIntent, quality: data.answerQuality, score: data.score, nextDifficulty: evalData.nextDifficulty, followUp: shouldFollowUp, struggleStreak: newStruggleStreak, topic: tag },
        'Answer processed'
    );
